...
module "smtp_submission_security_group" {
  source  = "terraform-modules/security-group/aws//modules/smtp-submission"
  version = "~> 0.1"
...
All automatic values **smtp-submission module** is using are available [here](https://github.com/kloia/terraform-modules/terraform-aws-security-group/blob/main/modules/smtp-submission/auto_values.tf).
