...
variable "kinesis_shard_count" {
  type        = number
  description = "Will be used when stream mode set to PROVISIONED"
  default     = 1
}
...
variable "kinesis_stream_mode" {
  type        = string
  description = "Streaming mode of kinesis data stream (it could be PROVISIONED(you need to set shard count for provisioned mode, and ON_DEMAND))"
  default     = "ON_DEMAND"
}


# Kinesis Firehose system
...
variable "firehose_bucket_name" {
  type        = string
  description = "Firehose backup,log bucket name"
  default     = ""
}

variable "firehose_policy_name" {
  type        = string
  description = "Firehose policy name"
  default     = ""
}
...
variable "firehose_es_index_name" {
  type        = string
  description = "Firehose index name"
  default     = ""
}

variable "firehose_index_rotation_period" {
  type        = string
  description = "Firehose index rotation"
  default     = ""
}

variable "firehose_cw_log_group_name" {
  type        = string
  description = "Firehose CloudWatch log group name"
  default     = ""
}

variable "firehose_cw_log_stream_name" {
  type        = string
  description = "Firehose CloudWatch log stream name"
  default     = ""
}

variable "index_field_enabled" {
  type        = bool
  description = "Create logging index at elasticsearch"
  default     = true
}
...
variable "firehose_cw_log_group_retention_in_days" {
  type        = number
