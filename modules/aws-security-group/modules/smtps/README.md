...
module "smtps_security_group" {
  source  = "terraform-modules/security-group/aws//modules/smtps"
  version = "~> 0.1"
...
All automatic values **smtps module** is using are available [here](https://github.com/kloia/terraform-modules/terraform-aws-security-group/blob/main/modules/smtps/auto_values.tf).
