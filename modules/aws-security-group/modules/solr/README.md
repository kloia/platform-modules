...
module "solr_security_group" {
  source  = "terraform-modules/security-group/aws//modules/solr"
  version = "~> 0.1"
...
All automatic values **solr module** is using are available [here](https://github.com/kloia/terraform-modules/terraform-aws-security-group/blob/main/modules/solr/auto_values.tf).
