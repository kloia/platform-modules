...
All automatic values **graphite-statsd module** is using are available [here](https://github.com/kloia/terraform-modules/terraform-aws-security-group/blob/main/modules/graphite-statsd/auto_values.tf).
