...
module "splunk_security_group" {
  source  = "terraform-modules/security-group/aws//modules/splunk"
  version = "~> 0.1"
...
All automatic values **splunk module** is using are available [here](https://github.com/kloia/terraform-modules/terraform-aws-security-group/blob/main/modules/splunk/auto_values.tf).
