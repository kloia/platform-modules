...
module "web_security_group" {
  source  = "terraform-modules/security-group/aws//modules/web"
  version = "~> 0.1"
...
All automatic values **web module** is using are available [here](https://github.com/kloia/terraform-modules/terraform-aws-security-group/blob/main/modules/web/auto_values.tf).
