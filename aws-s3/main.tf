...
locals {
  ...
  attach_policy = var.attach_require_latest_tls_policy || var.attach_elb_log_delivery_policy || var.attach_lb_log_delivery_policy || var.attach_deny_insecure_transport_policy || var.attach_cross_account_policy || var.attach_policy
...
data "aws_iam_policy_document" "combined" {
  ...
  source_policy_documents = compact([
    ...
    var.attach_cross_account_policy ? data.aws_iam_policy_document.s3_private_cross_account_policy[0].json : "",
...
data "aws_iam_policy_document" "s3_private_cross_account_policy" {
  count = local.create_bucket && var.attach_cross_account_policy ? 1 : 0
  statement {
    sid = "1"
