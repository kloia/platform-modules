...
module "prometheus_security_group" {
  source  = "terraform-modules/security-group/aws//modules/prometheus"
  version = "~> 4.0"
...
All automatic values **prometheus module** is using are available [here](https://github.com/kloia/terraform-modules/terraform-aws-security-group/blob/main/modules/prometheus/auto_values.tf).
