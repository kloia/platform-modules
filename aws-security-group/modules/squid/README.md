...
module "squid_security_group" {
  source  = "terraform-modules/security-group/aws//modules/squid"
  version = "~> 4.0"
...
All automatic values **squid module** is using are available [here](https://github.com/kloia/terraform-modules/terraform-aws-security-group/blob/main/modules/squid/auto_values.tf).
