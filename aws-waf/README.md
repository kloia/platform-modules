...
|------|-------------|------|---------|:--------:|
| <a name="input_ip_set_name"></a> [ip\_set\_name](#input\_ip\_set\_name) | IP Set Name  | `map(string)` | `{}` | yes |
| <a name="input_ip_set_addresses"></a> [ip\_set\_addresses](#input\_ip\_set\_addresses) | IP addresses | `list(string)` | `[]` | yes |
| <a name="input_create_waf"></a> [create\_waf](#input\_create\_waf) | condition to create | `bool` | `true` | no |
| <a name="input_waf_rule_name"></a> [waf\_rule\_name](#input\_waf\_rule\_name) | Name of the WAF rule | `string` | `""` | yes |
| <a name="input_waf_web_acl_name"></a> [waf\_web\_acl\_name](#input\_waf\_web\_acl\_name) | Name of the WAF ACL| `string` | `""` | yes |
| <a name="input_description"></a> [description](#input\description) | Description of the IP set| `string` | `""` | no |
| <a name="input_ip_set_description"></a> [ip\_set\_description](#input\ip\_set\_description) | Description of the IP set| `string` | `""` | no |
| <a name="input_metric_name"></a> [metric\_name](#input\metric\_name) | A friendly name of the CloudWatch metric| `string` | `""` | no |
| <a name="input_cw_metrics"></a> [cw\_metrics](#input\cw\_metrics) | CW metrics| `bool` | `false` | no |
