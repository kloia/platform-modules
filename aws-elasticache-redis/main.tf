...
resource "aws_elasticache_replication_group" "redis" {
  ...
  at_rest_encryption_enabled  = var.global_replication_group_id == null && var.at_rest_encryption_enabled ? var.at_rest_encryption_enabled : null
  transit_encryption_enabled  = var.global_replication_group_id == null && var.transit_encryption_enabled ? var.transit_encryption_enabled : null
